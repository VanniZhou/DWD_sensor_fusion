...
"""autogenerated by genpy from rockauto_msgs/TrafficLightResultArray.msg. Do not edit."""
import codecs
import sys
...
class TrafficLightResultArray(genpy.Message):
  ...
  _type = "rockauto_msgs/TrafficLightResultArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','rockauto_msgs/TrafficLightResult[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = rockauto_msgs.msg.TrafficLightResult()
        _v3 = val1.header
        start = end
        end += 4
