...
"""autogenerated by genpy from rockauto_msgs/DetectedObject.msg. Do not edit."""
import codecs
import sys
...
class DetectedObject(genpy.Message):
  ...
  _type = "rockauto_msgs/DetectedObject"
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.candidate_trajectories is None:
        self.candidate_trajectories = rockauto_msgs.msg.LaneArray()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.waypoints = []
        for i in range(0, length):
          val2 = rockauto_msgs.msg.Waypoint()
          _x = val2
          start = end
          end += 8
