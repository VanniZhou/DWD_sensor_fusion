// Generated by gencpp from file rockauto_msgs/CloudCluster.msg
// DO NOT EDIT!


#ifndef ROCKAUTO_MSGS_MESSAGE_CLOUDCLUSTER_H
#define ROCKAUTO_MSGS_MESSAGE_CLOUDCLUSTER_H
...
struct CloudCluster_
{
  ...
  typedef boost::shared_ptr< ::rockauto_msgs::CloudCluster_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rockauto_msgs::CloudCluster_<ContainerAllocator> const> ConstPtr;

}; // struct CloudCluster_

typedef ::rockauto_msgs::CloudCluster_<std::allocator<void> > CloudCluster;

typedef boost::shared_ptr< ::rockauto_msgs::CloudCluster > CloudClusterPtr;
typedef boost::shared_ptr< ::rockauto_msgs::CloudCluster const> CloudClusterConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rockauto_msgs::CloudCluster_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rockauto_msgs::CloudCluster_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::rockauto_msgs::CloudCluster_<ContainerAllocator1> & lhs, const ::rockauto_msgs::CloudCluster_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::rockauto_msgs::CloudCluster_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rockauto_msgs::CloudCluster_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rockauto_msgs::CloudCluster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rockauto_msgs::CloudCluster_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rockauto_msgs::CloudCluster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rockauto_msgs::CloudCluster_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rockauto_msgs::CloudCluster_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rockauto_msgs::CloudCluster_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xee7b21b447ceefbaULL;
  static const uint64_t static_value2 = 0x70710356a4b6162bULL;
};

template<class ContainerAllocator>
struct DataType< ::rockauto_msgs::CloudCluster_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rockauto_msgs::CloudCluster_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rockauto_msgs::CloudCluster_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rockauto_msgs::CloudCluster_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rockauto_msgs::CloudCluster_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ROCKAUTO_MSGS_MESSAGE_CLOUDCLUSTER_H
