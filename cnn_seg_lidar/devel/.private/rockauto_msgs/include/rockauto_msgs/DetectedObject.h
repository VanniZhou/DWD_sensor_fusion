// Generated by gencpp from file rockauto_msgs/DetectedObject.msg
// DO NOT EDIT!


#ifndef ROCKAUTO_MSGS_MESSAGE_DETECTEDOBJECT_H
#define ROCKAUTO_MSGS_MESSAGE_DETECTEDOBJECT_H
...
#include <rockauto_msgs/LaneArray.h>
...
struct DetectedObject_
{
  ...
  _convex_hull_type convex_hull;
   ...
   typedef  ::rockauto_msgs::LaneArray_<ContainerAllocator>  _candidate_trajectories_type;
  ...
  typedef boost::shared_ptr< ::rockauto_msgs::DetectedObject_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::rockauto_msgs::DetectedObject_<ContainerAllocator> const> ConstPtr;

}; // struct DetectedObject_

typedef ::rockauto_msgs::DetectedObject_<std::allocator<void> > DetectedObject;

typedef boost::shared_ptr< ::rockauto_msgs::DetectedObject > DetectedObjectPtr;
typedef boost::shared_ptr< ::rockauto_msgs::DetectedObject const> DetectedObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::rockauto_msgs::DetectedObject_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::rockauto_msgs::DetectedObject_<ContainerAllocator1> & lhs, const ::rockauto_msgs::DetectedObject_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::rockauto_msgs::DetectedObject_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::rockauto_msgs::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::rockauto_msgs::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
{
  ...
  static const char* value(const ::rockauto_msgs::DetectedObject_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2f8ff0bc8af23a66ULL;
  static const uint64_t static_value2 = 0x7b831af5bff9a15aULL;
};

template<class ContainerAllocator>
struct DataType< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::rockauto_msgs::DetectedObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rockauto_msgs::DetectedObject_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::rockauto_msgs::LaneArray_<ContainerAllocator> >::stream(s, indent + "  ", v.candidate_trajectories);
...
#endif // ROCKAUTO_MSGS_MESSAGE_DETECTEDOBJECT_H
