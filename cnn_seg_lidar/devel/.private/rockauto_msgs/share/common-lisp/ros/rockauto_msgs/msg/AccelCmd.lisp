...
(cl:defmethod cl:initialize-instance :after ((m <AccelCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AccelCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rockauto_msgs-msg:<AccelCmd> is deprecated: use rockauto_msgs-msg:AccelCmd instead.")))
...
(cl:defmethod accel-val ((m <AccelCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rockauto_msgs-msg:accel-val is deprecated.  Use rockauto_msgs-msg:accel instead.")
  (accel m))
