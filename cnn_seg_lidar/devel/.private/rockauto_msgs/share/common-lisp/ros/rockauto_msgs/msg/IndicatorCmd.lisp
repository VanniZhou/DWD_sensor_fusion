...
(cl:defmethod cl:initialize-instance :after ((m <IndicatorCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IndicatorCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rockauto_msgs-msg:<IndicatorCmd> is deprecated: use rockauto_msgs-msg:IndicatorCmd instead.")))
...
(cl:defmethod l-val ((m <IndicatorCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rockauto_msgs-msg:l-val is deprecated.  Use rockauto_msgs-msg:l instead.")
  (l m))
