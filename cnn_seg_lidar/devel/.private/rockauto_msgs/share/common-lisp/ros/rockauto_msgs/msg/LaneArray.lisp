...
(cl:defclass <LaneArray> (roslisp-msg-protocol:ros-message)
  ((lanes
    :reader lanes
    :initarg :lanes
    :type (cl:vector rockauto_msgs-msg:Lane)
   :initform (cl:make-array 0 :element-type 'rockauto_msgs-msg:Lane :initial-element (cl:make-instance 'rockauto_msgs-msg:Lane))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LaneArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LaneArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rockauto_msgs-msg:<LaneArray> is deprecated: use rockauto_msgs-msg:LaneArray instead.")))

(cl:ensure-generic-function 'lanes-val :lambda-list '(m))
(cl:defmethod lanes-val ((m <LaneArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rockauto_msgs-msg:lanes-val is deprecated.  Use rockauto_msgs-msg:lanes instead.")
  (lanes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LaneArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'lanes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rockauto_msgs-msg:Lane))
