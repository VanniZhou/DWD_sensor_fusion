...
(cl:defmethod cl:initialize-instance :after ((m <BrakeCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BrakeCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rockauto_msgs-msg:<BrakeCmd> is deprecated: use rockauto_msgs-msg:BrakeCmd instead.")))
...
(cl:defmethod brake-val ((m <BrakeCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rockauto_msgs-msg:brake-val is deprecated.  Use rockauto_msgs-msg:brake instead.")
  (brake m))
