...
(cl:defmethod cl:initialize-instance :after ((m <SteerCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SteerCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rockauto_msgs-msg:<SteerCmd> is deprecated: use rockauto_msgs-msg:SteerCmd instead.")))
...
(cl:defmethod steer-val ((m <SteerCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rockauto_msgs-msg:steer-val is deprecated.  Use rockauto_msgs-msg:steer instead.")
  (steer m))
