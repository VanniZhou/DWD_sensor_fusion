...
(cl:defclass <TrafficLightResultArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (results
    :reader results
    :initarg :results
    :type (cl:vector rockauto_msgs-msg:TrafficLightResult)
   :initform (cl:make-array 0 :element-type 'rockauto_msgs-msg:TrafficLightResult :initial-element (cl:make-instance 'rockauto_msgs-msg:TrafficLightResult))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TrafficLightResultArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrafficLightResultArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rockauto_msgs-msg:<TrafficLightResultArray> is deprecated: use rockauto_msgs-msg:TrafficLightResultArray instead.")))
...
(cl:defmethod results-val ((m <TrafficLightResultArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rockauto_msgs-msg:results-val is deprecated.  Use rockauto_msgs-msg:results instead.")
  (results m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TrafficLightResultArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'results)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'rockauto_msgs-msg:TrafficLightResult))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TrafficLightResultArray>)))
  ...
  "rockauto_msgs/TrafficLightResultArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TrafficLightResultArray)))
  "Returns string type for a message object of type 'TrafficLightResultArray"
  "rockauto_msgs/TrafficLightResultArray")
