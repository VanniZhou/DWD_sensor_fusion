...
class ValueSet {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.center, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ValueSet(null);
    // Deserialize message field [center]
    data.center = _deserializer.int32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ValueSet(null);
