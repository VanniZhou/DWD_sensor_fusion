...
VisualizeDetectedObjects::VisualizeDetectedObjects() : arrow_height_(0.5), label_height_(1.0)
{
  ...
  publisher_markers_ = node_handle_.advertise<visualization_msgs::MarkerArray>(
    markers_out_topic, 1);
      publisher_markers_boxes = node_handle_.advertise<visualization_msgs::MarkerArray>(
    “/cnn_seg_boxes”, 1);
...
void VisualizeDetectedObjects::DetectedObjectsCallback(const rockauto_msgs::DetectedObjectArray &in_objects)
{
  ...
  publisher_markers_boxes.publish(bounding_boxes);
  

}

visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToCentroids(const rockauto_msgs::DetectedObjectArray &in_objects)
{
...
visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToBoxes(const rockauto_msgs::DetectedObjectArray &in_objects)
{
...
visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToHulls(const rockauto_msgs::DetectedObjectArray &in_objects)
{
...
visualization_msgs::MarkerArray
VisualizeDetectedObjects::ObjectsToArrows(const rockauto_msgs::DetectedObjectArray &in_objects)
{
...
bool VisualizeDetectedObjects::IsObjectValid(const rockauto_msgs::DetectedObject &in_object)
{
  if (!in_object.valid ||
