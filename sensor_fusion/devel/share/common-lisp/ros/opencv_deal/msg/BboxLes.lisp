...
(cl:defclass <BboxLes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bboxl
    :reader bboxl
    :initarg :bboxl
    :type (cl:vector opencv_deal-msg:BboxL)
   :initform (cl:make-array 0 :element-type 'opencv_deal-msg:BboxL :initial-element (cl:make-instance 'opencv_deal-msg:BboxL))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BboxLes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BboxLes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name opencv_deal-msg:<BboxLes> is deprecated: use opencv_deal-msg:BboxLes instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <BboxLes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opencv_deal-msg:header-val is deprecated.  Use opencv_deal-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'image_header-val :lambda-list '(m))
(cl:defmethod image_header-val ((m <BboxLes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opencv_deal-msg:image_header-val is deprecated.  Use opencv_deal-msg:image_header instead.")
  (image_header m))

(cl:ensure-generic-function 'bboxl-val :lambda-list '(m))
(cl:defmethod bboxl-val ((m <BboxLes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader opencv_deal-msg:bboxl-val is deprecated.  Use opencv_deal-msg:bboxl instead.")
  (bboxl m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BboxLes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bboxl)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'opencv_deal-msg:BboxL))
