...
//	viewer.createViewPort(0.0, 0.0, 0.5, 1.0, outviewer);
	...
	shape_num=0;
        ...
        {
           //向视窗添加立方体模型并渲染，只显示线框。若不要显示线框将下面一行代码注释即可。float x_min, float x_max, float y_min, float y_max, float z_min, float z_max, double r=1.0, double g=1.0, double b=1.0, const std::string &id="cube", int viewport=0
